    ...
    for dataset in datasets:
        ...
        for iteration in range(1):
            ...
            if format(dataset["type"]) == '0' or format(dataset["type"]) == '2':
                add_results = ("UPDATE resultats SET poids_min= %s,poids_max= %s, capacite= %s, nombre_objets= %s, solDP= %s, tempsDP=%s WHERE id = %s")
            ...
            if format(dataset["type"]) == '1':
                add_results = ("UPDATE resultats SET poids_moyen= %s, capacite= %s, nombre_objets= %s, solDP= %s, tempsDP=%s WHERE id = %s")
